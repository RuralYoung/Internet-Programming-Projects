...
{
    if(confirm("Are you sure you want to return to your shopping cart?")) {
...
{
    if(confirm("Are you sure you want to checkout your shopping cart?")) {
...
{
    if(confirm("Are you sure you want to logout of your shopping cart?")) {
...
{
    if(confirm("Are you sure you want remove " + title + " from your cart?")) {
